...
git mv "src/ExampleNamespace/ExampleClass.php" "src/ExampleNamespace/${CAMEL}.php"
git mv "test/ExampleNamespace/ExampleClassTests.php" "src/ExampleNamespace/${CAMEL}Test.php"
